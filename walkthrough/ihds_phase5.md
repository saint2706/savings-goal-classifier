...
**Notebook:** [`notebooks/ihds_05_explainability.ipynb`](../notebooks/ihds_05_explainability.ipynb)
**Builds on:** [Phase 4 (IHDS-II)](ihds_phase4.md), [Phase 2 (IHDS-II)](ihds_phase2.md)
**Artifacts:** `results/ihds_shap_importance.csv`, `results/ihds_shap_summary.png`, `results/ihds_shap_dependence.png`
...
| **8 — Reporting** | `results/ihds_shap_summary.png` and `ihds_shap_dependence.png` replace the synthetic SHAP figure. The interaction result (41.9%) is the concrete reason a linear model was not selected. |
