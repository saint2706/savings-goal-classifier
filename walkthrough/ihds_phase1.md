...
**Notebook:** [`notebooks/ihds_01_eda_and_leakage_check.ipynb`](../notebooks/ihds_01_eda_and_leakage_check.ipynb)
**Builds on:** [Migration — Synthetic to IHDS-II](ihds_migration.md)
...
Loads `dataset/ihds2_households.csv` and declares four column groups up front: the 11 expense categories, their `_Share` counterparts, the behavioural `Has_*` columns, and `LEAKAGE_COLS`.
