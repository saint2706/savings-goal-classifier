...
**Notebook:** [`notebooks/ihds_04_model_comparison.ipynb`](../notebooks/ihds_04_model_comparison.ipynb)
**Builds on:** [Phase 3 (IHDS-II)](ihds_phase3.md)
**Artifacts:** `results/ihds_model_comparison.csv`, `results/ihds_model_comparison.png`
