...
**Notebook:** [`notebooks/ihds_03_baseline.ipynb`](../notebooks/ihds_03_baseline.ipynb)
**Builds on:** [Phase 2 (IHDS-II)](ihds_phase2.md)
**Artifacts:** `results/ihds_baseline.csv`, `results/ihds_baseline.png`
