...
``walkthrough/ihds_migration.md`` for the reasoning behind every mapping and
threshold in this file.

Usage:
    python src/build_ihds_dataset.py --tsv path/to/36151-0002-Data.tsv \
        --out dataset/ihds2_households.csv
...
def main() -> None:
    ...
    parser.add_argument("--out", default=Path("dataset/ihds2_households.csv"), type=Path)
    parser.add_argument(
        "--threshold",
        default=0.20,
        type=float,
